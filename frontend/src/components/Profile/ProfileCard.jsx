  ...
  // useEffect(() => {
    const getUserData = async () => {
      ...
      const response = await axios.get(
        `https://ecommerce-follow-along-lkys.onrender.com/user/user-data?token=${token}`
      );
  ...
  const handleDeleteAddy = async (id) => {
    ...
    try {
      ...
      const response = await axios.delete(
        `https://ecommerce-follow-along-lkys.onrender.com/user/delete-address/${id}?token=${token}`
      );
      getUserData();
    } catch (er) {
